	...
	<div class="card-body">
		...
		<div class="row">
			...
			<div class="col-lg-4" id="cuando" style="display:none">
				{!! Form::label ('','¿Cuándo?') !!}
				{!! Form::text ('fecha_visita',old('fecha_visita'), ['class' => 'form-control mayuscula', 'id' => 'fecha_visita','placeholder' => 'DD/MM/AAAA','data-validation-depends-on' => 'entrevistadorPrimeraVez','data-validation-depends-on-value' =>'NO','data-validation-format'=>"dd-mm-yyyy" ] )!!}
