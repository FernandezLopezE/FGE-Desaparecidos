...
<p class="fuente"><strong> ING. </strong>	<strong> {{--{!! $datos->nombreRemitente !!}--}} </strong>
	</p>
	<p class="fuente"><strong> C. APODERADO LEGAL DE LA EMPRESA DE TELEFONÍA DENOMINADA</strong>
	</p>
	...
	<div>
		...
		<p class="fuente">	Copia de la denuncia;</p>
	</div>

	<div id="sangria">

        <p class="fuente">
			Lo anterior para que realice geolocalización en tiempo real del número telefónico <strong>{{--{!! $datos->desaparecidoTelefono !!} --}}</strong>, en intervalos de <strong>{{--{!! $datos->minutosHoras !!} --}}</strong> (minutos, horas según sea el caso) a partir de la recepción del presente documento hasta el día <strong>{{--{!! $datos->desaparecidoFecha !!} --}}</strong>.
		</p>
		<p class="fuente">
			Debido a que estas acciones contribuyen a la búsqueda eficiente del ciudadano <strong>{{--{!! $datos->desaparecidoNombre !!} --}}</strong>, quien se encuentra privado de su libertad por lo que existen elementos suficientes para suponer que su vida e integridad física se encuentran en peligro.
		</p>
		<p class="fuente">
			Proporcionando como medio para recibir la información solicitada el siguiente correo institucional: <strong>{{--{!! $datos->correoInstitucional !!} --}}</strong>.
		</p>
		<p class="fuente">
