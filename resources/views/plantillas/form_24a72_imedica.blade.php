...
<div id="cuerpo">
	...
	<p class="fuente"><strong> DR.  </strong>	<strong> {{--{!! $datos->nombreRemitente !!}--}} </strong>
	</p>
	<p class="fuente"><strong> INSTITUCIÓN DE SALUD: <strong> {{--{!! $datos->institutoSalud !!}--}} </strong>
</strong>
	</p>
