...
<div id="cuerpo">
	...
	<div id="sangria">
		...
		<p class="fuente">
			1.	Copia del Kardex y/o expediente laboral de los siguientes Servidores Públicos:
		<p class="fuente">
			<strong>{{--{!! $datos->servidor1 !!} --}} </strong></p>
		</p>
		<p class="fuente">
			<strong>{{--{!! $datos->servidor2 !!} --}} </strong></p>
		</p>
		<p class="fuente">
			<strong>{{--{!! $datos->servidor3 !!} --}} </strong></p>
		</p>
		<br>
		<p class="fuente">
