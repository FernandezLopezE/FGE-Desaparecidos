    ...
    <div class="card-body"> 
		...
		<div class="form-group row" id="cabello">
		    <div class="col" style="display:none;" id="a">
                {!! Form::text('tipoCabello', '', ['class' => 'form-control', 'id' => 'otroTipoC', 'placeholder' => 'Especifique otro tipo'] ) !!}
		    </div>
		    <div class="col" style="display:none;" id="b">
                {!! Form::text('colorCabello', '', ['class' => 'form-control', 'id' => 'otroColorC', 'placeholder' => 'Especifique otro color'] ) !!}
		    </div>
		    <div class="col" style="display:none;" id="c">
                {!! Form::text('partiCabello', '', ['class' => 'form-control', 'id' => 'otroPartiC', 'placeholder' => 'Especifique otra particularidad'] ) !!}
		    </div>
		</div>
