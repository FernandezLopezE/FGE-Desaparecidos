...
<div id="cuerpo">
	...
	<p class="fuente"><strong> Secretario de Seguridad Pública del Estado de Veracruz y/o Director de la Policía Ministerial y/o Encargado de la Región XXXI Xalapa  de la Policía Federal, y/o Encargado de la 26/A Zona Militar, dependiendo de la autoridad señalada como presunta responsable.</strong>
	</p>
	...
	<div id="sangria">
		...
		<p align="justify" class="fuente">
			1.- Álbum fotográfico que contenga nombre y área de adscripción de cada uno de los elementos de la Policía Estatal (o Fuerza Civil según sea el caso) adscritos a la Secretaría de Seguridad Publica en la región de <strong>{{--{!! $datos->region !!} --}}</strong> Veracruz.
		</p>
		<br>
		<p align="justify" class="fuente">
			 2.- Parque vehicular asignado a la región de <strong>{{--{!! $datos->region !!} --}}</strong> Veracruz.
		</p>
		<br>
		<p align="justify" class="fuente">
			3.-Estado de fuerza, fatigas de personal, parque vehicular, bitácoras y partes de novedades relativo a elementos adscritos a la Delegación ________ de la Policía Estatal y correspondientes a los días ________________.
		</p>
		<br>
		<p align="justify" class="fuente"">
			4.- Estado de fuerza, fatigas de personal, parque vehicular, bitácoras y partes de novedades relativas a los miembros de Fuerza Civil que hayan estado activos los días _______________, en la ciudad de _____________, correspondientes a los días ________________.
		</p>
		<br>
		<p align="justify" class="fuente">
			5.- Estado de fuerza, fatigas de personal, parque vehicular, bitácoras y partes de novedades relativas a cualquier otro agrupamiento, que haya operado en la ciudad de __________________ durante los días ___________________________, correspondientes a los días ___________________.
		</p>
		<br>
		<p align="justify" class="fuente"">
			6.- Padrón vehicular encargado de la vigilancia y/o patrullaje del sector que comprende las calles _________ (lugar donde se llevó a cabo la intervención), correspondiente a los días ______________, así como los elementos asignados a cada vehículo. 
		</p>
		<br>
		<p align="justify" class="fuente">
