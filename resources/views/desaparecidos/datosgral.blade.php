<div class="card border-primary">
	...
	<div class="card-body">
			...
			<div class="col">
				...
				{!! Form::text ('edadExtravio',
								...
								['class' => 'form-control',
									...
									'data-validation-error-msg' => '* Ingresar edad',  'data-validation-length'=>"0-3",'data-mask'=>"000"
								] )!!}
			</div>
			<div class="col">
				...
				{!! Form::text ('edadAparente',
								old('Edad aparente'), 
								['class' => 'form-control', 
									'placeholder' => 'Escribe la edad aparente',
									'id' => 'edadAparente', 
									'data-validation' => 'required number length', 
									'data-validation-error-msg' => '* Ingrese una edad aparente',  'data-validation-length'=>"0-3",'data-mask'=>"000"
								] )!!}
			</div>
			<div class="col">
				...
				{!! Form::text ('fechaNacimiento',
								...
								['class' => 'form-control', 
									...
									'data-validation-error-msg' => '* Ingrese o corrija la fecha de nacimiento',
		...
		<div class="row">
			...
			<div class="col">
				{!! Form::label ('primerAp','Primer apellido:') !!}
				{!! Form::text ('familiaresPrimerAp[]',
								'', 
								['class' => 'form-control mayuscula', 
									'placeholder' => 'Escribe el primer apellido',
									'id' => 'familiaresPrimerAp', 
									'data-validation' => 'required', 
			...
			<div class="col">
				{!! Form::label ('segundoAp','Segundo apellido:') !!}
				{!! Form::text ('familiaresSegundoAp[]',
								'', 
								['class' => 'form-control mayuscula', 
									'placeholder' => 'Escribe el segundo apellido',
									'id' => 'familiaresSegundoAp'
								] )!!}
			</div>
			<div>
			...
			<div class="col">
				...
				{!! Form::text ('familiaresPrimerAp[]',
									...
									['class' => 'form-control mayuscula', 
										...
										'id' => 'familiaresPrimerAp', 
										'data-validation' => 'required', 
										'data-validation-error-msg-required' => '* Ingrese el primero apellido'
									] )!!}
			</div>
			<div class="col">
				{!! Form::label ('segundoAp','Segundo apellido:') !!}
	...
	<div class="card-body">
		<div class="row"  id="datosEmbarazo" style="display:none">
			<div class="col">
				...
				{!! Form::text ('gestacionSemanas',
								old('gestacionSemanas'), 
								['class' => 'form-control mayuscula', 
									'placeholder' => 'Escribe las semanas',
									'id' => 'gestacionSemanas'
								] )!!}
			</div>
			<div class="col">
				{!! Form::label ('gestacionMeses','Meses:') !!}
				{!! Form::text ('gestacionMeses',
								old('gestacionMeses'), 
								['class' => 'form-control mayuscula', 
									'placeholder' => 'Escribe los meses',
									'id' => 'gestacionMeses'
								] )!!}
			</div>
			<div class="col">
		...
		<div class="row" id="datosEmbarazo3" style="display:none">
			<div class="col-12">
				...
				{!! Form::text ('pormenores',
								old('Pormenores'), 
								['class' => 'form-control mayuscula', 
									'placeholder' => 'Escribe los pormenores',
									'id' => 'pormenores'
								] )!!}
			</div>
		</div>
