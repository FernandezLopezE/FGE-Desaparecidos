		...
		<div class="row">
			...
			<div class="col">
				...
				{!! Form::text ('edadAparente',
								...
								'data-validation-length'=>"0-3",'data-mask'=>"000"] )!!}
			</div>
			<div class="col">
		...
		<div class="row" >
			...
			<div class="col">
				...
				{!! Form::text ('familiaresEdad[]','', 
								...
								'data-validation-permitted' => 'range [1; 100]', 'data-validation-error-msg-requ'* Solo puedes ingresar números'] )!!}
			</div>			
		</div>
	</div>
</div>
...
<div class="card border-primary" id="estaEmbarazada" style="display:none">
	<div class="card-header">
		<div class="col">
			...
			{!! Form::select ('embarazo',['NO'=>'NO','SI'=>'SI', 'LO IGNORAN' => 'LO IGNORAN'],'', 
							 ['class' => 'form-control', 
							 'id' => 'embarazo'] )!!}
		</div>		
	</div>
