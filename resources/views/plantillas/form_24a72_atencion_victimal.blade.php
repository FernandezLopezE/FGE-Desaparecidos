...
<div id="cuerpo">
	...
	<p class="fuente"><strong> Director (A) del Centro Estatal de Atención a Victimas
En la Fiscalía General del Estado de Veracruz
	...
	<div id="sangria">
		<br>
		<p align="justify" class="fuente">
			Brinde atención integral a la ciudadana ____________________________, con domicilio en __________________________ y numero de teléfono ________________, lo anterior debido a que resulta ser víctima indirecta a raíz de la desaparición del ciudadano _________________________ quien es su ___________.
		</p>
		<br>
		<br>
		<p align="justify" class="fuente">
			Solicitándole remita en un término no mayor a 48 horas el informe inicial sobre las acciones implementadas para cumplimentar lo anterior.
		</p>
		<br>
		<p align="justify" class="fuente">
			Debiendo remitir cada quince días informe documentado sobre la atención brindada a la ciudadana ____________________________.
		</p>
		<br>
		<p align="justify" class="fuente">
