<div class="card border-primary">
	...
	<div class="row" id=""  > 	
		<div class="col-lg-3">
			...
			{!! Form::select ('idNacionalidad',$nacionalidades,
							'',
							['class' => 'form-control',
										'id' => 'idNacionalidad',
	...
	{!! Form::select ('informanteidMunicipio[]',
						$municipios,
						'',
						['class' => 'form-control',
									'id' => 'informanteidMunicipio'
						] )!!}				
		</div>
		<div class="col-lg-4">
	...
	<div class="row" id=""  > 	
		<div class="col-lg-8">
			...
			{!! Form::select ('informanteidColonia[]',
								$colonias,
								'',
								['class' => 'form-control',
											'id' => 'informanteidColonia'
								] )!!}				
		</div>
		<div class="col-lg-4">
			{!! Form::label ('informanteidCodigoPostal','Código postal:') !!}
			{!! Form::text ('informanteidCodigoPostal',
							old('informanteidCodigoPostal'),
							['class' => 'form-control mayuscula',
										'id' => 'informanteidCodigoPostal',
							] )!!}				
		</div>
	</div><br>
	...
	<div class="row" id=""  > 
		<div class="col-lg-2">
			...
			{!! Form::select ('',
							['CASA'=>'CASA','TRABAJO'=>'TRABAJO','PERSONAL'=>'PERSONAL'],
							'',
							['class' => 'form-control',
										'id' => ''
							] )!!}	
		...
		<div class="col-lg-4">
			...
			{!! Form::text ('informanteCorreoElectronico',
							old('informanteCorreoElectronico'),
							['class' => 'form-control mayuscula',
										'id' => 'informanteCorreoElectronico',
							] )!!}				
		</div>
	</div><br>
