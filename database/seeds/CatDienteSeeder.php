...
class CatDienteSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('cat_dientes')->insert([
            ...
            [ 'id' => 3, 'numDiente' => 13, 'nombreDiente' => 'CANINO SUPERIOR DERECHO'],
            ...
            [ 'id' => 11, 'numDiente' => 23, 'nombreDiente' => 'CANINO SUPERIOR IZQUIERDO'],
            ...
            [ 'id' => 16, 'numDiente' => 28, 'nombreDiente' => 'TERCER MOLAR SUPERIOR IZQUIERDO'],
            ...
            [ 'id' => 19, 'numDiente' => 33, 'nombreDiente' => 'CANINO INFERIOR IZQUIERDO'],
            ...
            [ 'id' => 24, 'numDiente' => 38, 'nombreDiente' => 'TERCER MOLAR INFERIOR IZQUIERDO'],
            ...
            [ 'id' => 27, 'numDiente' => 43, 'nombreDiente' => 'CANINO INFERIOR DERECHO'],
            ...
            [ 'id' => 30, 'numDiente' => 46, 'nombreDiente' => 'PRIMER MOLAR INFERIOR DERECHO'],
            [ 'id' => 31, 'numDiente' => 47, 'nombreDiente' => 'SEGUNDO MOLAR INFERIOR DERECHO'],
            [ 'id' => 32, 'numDiente' => 48, 'nombreDiente' => 'TERCER MOLAR INFERIOR DERECHO'],
        ]);
    }
}
