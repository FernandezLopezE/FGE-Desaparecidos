...
<p class="fuente"><strong> LIC. </strong>	<strong> {{--{!! $datos->nombreRemitente !!}--}} </strong>
	...
	<p class="fuente"><strong> Encargado del Centro Estatal de Control, Comando, Comunicaciones y Cómputo, C4, Xalapa, Ver.
 </strong>
	</p>
	...
	<div id="sangria">
        ...
        <p class="fuente">
            Que realice las gestiones necesarias a efecto de remita en un término no mayor a Cuarenta y ocho horas, copia de los videos de vigilancia de las cámaras de videograbación ubicadas en <strong> {{--{!! $datos->domicilio !!}--}} </strong>, de fecha <strong> {{--{!! $datos->fecha !!}--}} </strong> durante el periodo de tiempo comprendido entre las <strong> {{--{!! $datos->horas !!}--}} </strong> horas y <strong> {{--{!! $datos->horas !!}--}} </strong> horas.
		</p>
       <br>
        <p class="fuente">
