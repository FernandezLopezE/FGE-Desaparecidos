...
Route::post('consultas/get_desaparecidos_personas/{masc}/{fem}/{rg}/{rg2}/{estados}/{municipios}/{estatura1}/{estatura2}/{peso1}/{peso2}/{cPiel}/{complexion}', 'ConsultasController@jsonDesaparecidosPersona')->name('consultas.get_desaparecidos_personas');
