<div class="card border-success">
	...
	<div class="card-body">	
		...
		<div class="row">
			<div class="col-2">				
				{!! Form::text ('avistoFechaHora',
								old('Fecha de la última vez que fue visto'), 
								['class' => 'form-control', 
								'id' => 'avistoFechaHora' , 
								'data-validation' => 'required date', 
								'data-validation-error-msg' => 'Ingrese la fecha',
								'data-validation-format'=>"dd-mm-yyyy"] )!!}
			</div>
			<div class="col-1">
			</div>		
			<div class="col-2">
				{!! Form::text ('avistoHoraExtravio',
								old('Hora'), 
								['class' => 'form-control', 
								'id' => 'avistoHoraExtravio', 
								'data-validation' => 'required  time', 
								'data-validation-error-msg' => 'Ingrese la hora HH:mm'] )!!}
			</div>
		</div>	
		<div class="row">
				<br/>		
		...
		<div class="row">
			<div class="col">
				...
				{!! Form::text ('avistoNombres',
								old('Nombres(s)'), 
								['class' => 'form-control mayuscula', 
								'id' => 'avistoNombres', 
								'data-validation' => 'required', 
								'data-validation-error-msg-required' => 'Ingrese el nombre(s)'] )!!}
			</div>
			<div class="col">
				{!! Form::label ('primerApellidoAvisto','Primer apellido:') !!}
				{!! Form::text ('avistoPrimerAp',
								old('Primer apellido'), 
								['class' => 'form-control mayuscula', 
								'id' => 'avistoPrimerAp', 
								'data-validation' => 'required', 
			...
			<div class="col">
				...
				{!! Form::text ('avistoSegundoAp',
								old('Segundo apellido'), 
								['class' => 'form-control mayuscula', 
								'id' => 'avistoSegundoAp'] )!!}
			</div>
			<div class="col">
				{!! Form::label ('parentescoDesaparecido','Parentesco:') !!}
				{!! Form::select ('avistoidParentesco[]',
								 $parentescos,'', 
								 ['class' => 'form-control', 
								 'id' => 'avistoidParentesco'] )!!}
			</div>
		</div>	
		...
		<div class="row">
			...
			<div class="form-group col">
				...
				{!! Form::select ('avistoidMunicipio[]',
								 $municipios,'', 
								 ['class' => 'form-control', 
								 'id' => 'avistoidMunicipio'] )!!}
			</div>
			<div class="form-group col">
				{!! Form::label ('avistoLocalidad','Localidad:') !!}
				{!! Form::select ('avistoidLocalidad[]',
								 $localidades,'', 
								 ['class' => 'form-control', 
								 'id' => 'avistoidLocalidad'] )!!}
			</div>
			<div class="form-group col">
				{!! Form::label ('avistoColonia','Colonia:') !!}
				{!! Form::select ('avistoidColonia[]',
								 $colonias,'', 
								 ['class' => 'form-control', 
								 'id' => 'avistoidColonia'] )!!}
			</div>		
		...
		<div class="row">
			<div class="col">
				...
				{!! Form::textarea  ('avistoDescripcionHechos',
									old('Breve descripción del hecho'), 
									['class' => 'form-control mayuscula', 
									'id' => 'avistoDescripcionHechos',
									'size' => '30x4',
									'data-validation' =>'required',
									'data-validation-error-msg-required' =>'Ingrese la descripción del hecho'])!!}
			</div>
		</div>	
	</div>
</div>
