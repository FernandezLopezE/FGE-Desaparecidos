...
<p class="fuente"><strong> LIC. </strong>	<strong> {{--{!! $datos->nombreRemitente !!}--}} </strong>
	...
	<p class="fuente"><strong>Secretario de Seguridad Pública del Estado de Veracruz y/o Director de la Policía Ministerial y/o Encargado de la Región XXXI Xalapa, de la Policía Federal, y/o Encargado de la 26/A Zona Militar
 </strong>
	</p>
	...
	<div id="sangria">
        ...
        <p class="fuente">
            <strong>1.-</strong> Ponga a la vista de esta Fiscalía ubicada en <strong> {{--{!! $datos->domicilioFiscalia !!}--}} </strong>, las armas asignadas a los elementos: <strong> {{--{!! $datos->nombresPersonas !!}--}} </strong>
		</p>
		<p class="fuente">
		    <strong>2.-</strong> Presentando además los resguardos por cada una de las armas asignadas a los elementos policiacos antes mencionados;
		</p>
		<p class="fuente">
		    <strong>3.-</strong> De igual manera deberá poner la vista la Unidad automotora número <strong> {{--{!! $datos->numeroUnidad !!}--}} </strong>, con placas de circulación <strong> {{--{!! $datos->placasCirculacion !!}--}} </strong>.
		</p>
		<p class="fuente">
		    <strong>4..-</strong> Así como los uniformes e insignias portadas por los elementos citados en el punto numero 1.
		</p>
		<p class="fuente">
	...
	<p align="justify" class="fuente">
	    Lo anterior  en un término no mayor  a 24 horas contadas a partir de la recepción del presente ocurso. Sin más por el momento aprovecho la ocasión para enviarle un cordial saludo.
	</p>
</div>
	<br>
<div id="atentamente">
