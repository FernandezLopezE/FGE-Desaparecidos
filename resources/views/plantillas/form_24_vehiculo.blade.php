...
<p class="fuente"><strong> LIC. </strong>	<strong> {{--{!! $datos->nombreRemitente !!}--}} </strong>
	...
	<p class="fuente"><strong> Apoderado Legal de la Persona Moral Denominada </strong><strong> {{--{!! $datos->compañiaAuto !!}--}}  </strong>
	</p>
	...
	<div id="sangria">
        ...
        <p class="fuente">
			Lo anterior para que realice las gestiones necesarias e informe a esta Fiscalía, sobre los movimientos y/o ubicaciones registrados a través del GPS con el que cuenta el vehículo descrito líneas arriba, desglosado de la siguiente manera:
		</p>
		<p class="fuente">
		    Dirección, fecha y hora de ser posible duración del trayecto.
            Lo anterior desde el día <strong>{{--{!! $datos->desaparecidoFecha !!} --}}</strong> (agregar fecha de por lo menos dos días antes a la desaparición),  a la fecha de recepción del presente.
		</p>
		<p class="fuente">
		...
		<p class="fuente">
			La información solicitada deberá ser remitida en un término no mayor a 24 horas, ya que resulta esencial para la integración de la Carpeta de Investigación abierta con motivo de la denuncia de la desaparición del C. <strong>{{--{!! $datos->desaparecidoNombre !!} --}}</strong>.  Sin más por el momento aprovecho la ocasión para enviarle un cordial saludo.
		</p>
