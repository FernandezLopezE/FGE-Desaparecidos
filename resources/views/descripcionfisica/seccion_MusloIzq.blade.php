<div class="musloIzq" id="formMusloIzq" style="display:none;">
	<div class="card border-success" >
		<div class="card-header">
			<h5 class="card-title">Muslo Izquierdo
		...
		<div class="card-body">
			<div class="form-group row">
				<div class="col">
					{!! Form::label ('partMusloIzq','Particularidades') !!}
					{!! Form::select('partMusloIzq', $tipoCeja, '', ['class' => 'form-control', 'id' => 'partMusloIzq'] ) !!}
				</div>
				<div class="col">
					{!! Form::label ('modMusloIzq','Modificaciones') !!}
					{!! Form::select('modMusloIzq', array('SIN INFORMACIÓN' => 'SIN INFORMACIÓN', 'SÍ' => 'SÍ', 'NO' => 'NO'), '', ['class' => 'form-control', 'id' => 'modMusloIzq'] ) !!}
				</div>
			</div>
			...
			<button type="button" class="btn btn-primary" style="float: right;" id="guardarMusloIzq">GUARDAR</button>
		</div> 
	</div>
</div>