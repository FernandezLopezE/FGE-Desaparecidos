...
<div id="cuerpo">
	...
	<p class="fuente"><strong> Secretario de Comunicaciones y Transporte </strong>
	</p>
	...
	<div id ="sangria">
		...
		<p class="fuente" align="justify">
			Que realice las gestiones necesarias a efecto de remita en un término no mayor a Cuarenta y ocho horas, copia de los videos de vigilancia de las casetas de cobro ubicadas en <strong> {{--{!! $datos->casetaLugar1!!} --}} </strong>, Veracruz y <strong> {{--{!! $datos->casetaLugar2!!} --}} </strong> Veracruz, de fecha<strong> {{--{!! $datos->desaparecidoFecha!!} --}} </strong>durante el periodo de tiempo comprendido entre las <strong> {{--{!! $datos->horaCaseta1!!} --}} </strong> horas y <strong> {{--{!! $datos->horaCaseta1!!} --}} </strong> horas.
		</p>
		<br>
		<p class="fuente" align="justify">
		Ya que estas acciones contribuyen la búsqueda eficiente del ciudadano  <strong> {{--{!! $datos->desaparecidoNombre!!} --}} </strong>, quien se encuentra desaparecido.
		</p>
		<br>
		<p class="fuente" align="justify">
