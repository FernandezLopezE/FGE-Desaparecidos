...
<div id="cuerpo">
	...
	<div>
		...
		<p class="fuente" align="justify">
			<strong> 1.-</strong>Recolección de muestras biológicas a la ciudadana <strong> {{--{!! $datos->desaparecidoNombre !!}--}}  </strong>, quien se traslada a las instalaciones a su digno cardo el dia <strong> {{--{!! $datos->fechaDia !!}--}}  </strong> a las <strong> {{--{!! $datos->Hora !!}--}}  </strong> horas.
		</p>

		<p class="fuente" align="justify">
			<strong> 2.-</strong>Una vez hecho lo anterior obtenga perfil genético de las muestras recolectadas a <strong> {{--{!! $datos->desaparecidoNombre !!}--}}  </strong>;
        </p>
		<p class="fuente" align="justify">
			<strong> 3.-</strong>Se lleve a cabo confronta con la base de datos genética así como con el perfil genético obtenido de los cadáveres y/o restos óseos en calidad de desconocidos;
		</p>
	</div>
	<div id="sangria">
		<p class="fuente" align="justify">
			Solicitando remita el dictamen de referencia en un término no mayor a 48 horas, ya que estas acciones contribuyen a la búsqueda eficiente del ciudadano <strong> {{--{!! $datos->desaparecidoNombre !!}--}}  </strong>.  
		</p><br>
		<p class="fuente" align="justify">
