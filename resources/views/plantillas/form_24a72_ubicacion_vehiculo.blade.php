...
<p class="fuente"><strong> LIC. </strong>	<strong> {{--{!! $datos->nombreRemitente !!}--}} </strong>
	...
	<p class="fuente">	<strong> Apoderado Legal de la Persona Moral Denominada: </strong>
 </strong>
	</p>
	...
	<div >
        ...
        <p class="fuente" align="justify">
           Lo anterior para que realice las gestiones necesarias eh informe a esta Fiscalía, la última ubicación registrada a través del GPS con el que cuenta el vehículo descrito líneas arriba, desglosado de la siguiente manera:
		</p>
        <p class="fuente" align="justify">
