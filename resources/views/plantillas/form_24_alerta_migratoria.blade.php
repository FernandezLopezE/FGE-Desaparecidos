...
<div id="cuerpo">
	...
	<div>
		...
		<p class="fuente">	Copia de Acta de nacimiento (en caso de contar con ella);</p>
		<p class="fuente">	Copia de credencial de elector(En caso de contar con ella);</p>
		<p class="fuente">	Copia de Pasaporte (En caso de contar con el).</p>
	</div>
