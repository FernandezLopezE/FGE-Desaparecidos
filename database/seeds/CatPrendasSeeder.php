...
class CatPrendasSeeder extends Seeder
{
    ...
    public function run()
    {
        $prendas= array(
            ...
            [ 'nombre' => 'CARTERA', 'idVestimenta' => '5','sexo' => ''],
            [ 'nombre' => 'CELULAR', 'idVestimenta' => '5','sexo' => ''],
            [ 'nombre' => 'CREDENCIALES', 'idVestimenta' => '5','sexo' => ''],
            [ 'nombre' => 'TARJETA DE CRÉDITO/DÉBITO', 'idVestimenta' => '5','sexo' => ''],
