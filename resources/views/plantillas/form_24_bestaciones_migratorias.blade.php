...
<div id="cuerpo">
	...
	<p class="fuente"><strong> Delegado Federal del Instituto Nacional de Migración en el Estado de Veracruz</strong>
	</p>
	...
	<div id="sangria">
		...
		<p align="justify" class="fuente">
			Lo anterior, a efecto de que las documentales antes señaladas sean distribuidas en los distintas estaciones Migratorias de este Estado y sean colocadas en lugares visibles al público en general, ya que estas acciones contribuyen a la búsqueda eficiente del ciudadano  <strong>{{--{!! $datos->desaparecidoNombre !!} --}}</strong>.
		</p>
		<br>
		<br>
		<p align="justify" class="fuente">
			También, deberá informar si existe ingreso de persona que coincida con el nombre y/o Características físicas del ciudadano <strong>{{--{!! $datos->desaparecidoNombre !!} --}}</strong>, en cualquiera de las distintas estaciones migratorias, a partir del día <strong>{{--{!! $datos->desaparecidoHora !!} --}}</strong>, a la fecha de recepción del presente.
		</p>
		<br>
		<br>
		<p align="justify" class="fuente">
