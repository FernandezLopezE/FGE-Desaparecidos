<div class="form-horizontal">
	...
	<div class="form-group row">
		...
		<div class="col-6">
			{!! Form::label ('nacionalidades','Nacionalidad') !!}
        		{!! Form::select ('nacionalidades',$nacionalidad,'', ['class' => 'form-control','placeholder' => 'Mexicana'] )!!}
		</div>
		<!--fin de Nacionalidad -->
	</div>
	...
	<div class="form-group row">
		<div class="col-3">
			{!! Form::label ('idEscolaridad','Estado civil') !!}
        		{!! Form::select ('idEscolaridad',$idEscolaridad,'', ['class' => 'form-control'] )!!}
		</div>
		<div class="col-3">
			{!! Form::label ('idOcupacion','Estado civil') !!}
        		{!! Form::select ('idOcupacion',$idOcupacion,'', ['class' => 'form-control'] )!!}
		</div>	
		<div class="col-3">
			{!! Form::label ('idEdocivil','Estado civil') !!}
        		{!! Form::select ('idEdocivil',$idEdocivil,'', ['class' => 'form-control'] )!!}
		</div>	
	</div>
	...
	<div class="form-group row" name="tieneHijos" id="tieneHijos">
		{!! Form::label ('hijos','Hijos') !!}
        		{!! Form::select ('hijos',$hijos,'', ['class' => 'form-control'] )!!}
	</div>
	...
	<div class="form-group row" id="nombreHijo" style="display:none">
		...
		<div class="col-3">
			{!! Form::submit('Agregar otro'), ['class' => 'form-control'] !!}
		</div>	
	</div><hr>
	...
	<div class="form-group row" id="estaEmbarazada">
		{!! Form::label ('embarazo','Esta embarazada') !!}
        		{!! Form::select ('embarazo',$embarazo,'', ['class' => 'form-control'] )!!}
	</div>
	...
	<div class="form-group row" id="rumores" style="display:none">
		...
		{!! Form::label ('rumor','Rumores sobre el nacimiento') !!}
        		{!! Form::select ('rumor',$rumor,'', ['class' => 'form-control'] )!!}
	</div>
