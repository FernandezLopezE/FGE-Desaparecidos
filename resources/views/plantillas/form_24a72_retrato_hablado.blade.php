...
<div id="cuerpo">
	...
	<div >
		...
		<p class="fuente" align="justify">
			1.- Retrato de persona, con base  en las características que le serán proporcionadas por la ciudadana <strong> {{--{!! $datos->informanteNombre !!}--}} </strong>, quien se presentará en las instalaciones a su digno cargo el día <strong> {{--{!! $datos->retratoCitaFecha !!}--}} </strong>, a la <strong> {{--{!! $datos->retratoCitaHora !!}--}} </strong>horas.
		</p>
