...
<div id="cuerpo">
	...
	<p class="fuente"><strong> Director General de los Servicios Periciales y/o Delegado Regional de Servicios Periciales <strong> {{--{!! $datos->???????????? !!}--}}  </strong>, Veracruz  </strong>
	</p>
	...
	<div id="sangria">
		...
		<p align="justify"  class="fuente">
			Con fundamento en lo que disponen el artículo 19, 20 y 21 de la Constitución General de la República; 67 Fracción I apartado A de la Constitución Política Local;
			</p>
		<br>	
	</div>
	<p align="justify" class="fuente">
	...
	<div>
		...
		<p class="fuente" align="justify">
			<strong> 1.-</strong>Si en cualquiera de las Unidades Integrales  de sus jurisdicciones, se ha dado inicio a investigación ministerial y/o carpeta de investigación respecto de los hechos <strong> {{--{!! $datos->numOficio !!}/{!! $datos->anio !!} --}} </strong>, suscitados <strong> {{--{!! $datos->????????? !!}/{!! $datos->anio !!} --}} </strong>, en la colonia <strong> {{--{!! $datos->Colonia !!}/{!! $datos->anio !!} --}} </strong>, en <strong> {{--{!! $datos->Colonia !!}/{!! $datos->municipio !!} --}} </strong>, Veracruz; mismos que se relacionan a la desaparición del ciudadano <strong> {{--{!! $datos->Colonia !!}/{!! $datos->desapareciNombre !!} --}} </strong>, pues hay coincidencia entre el modus operandi y/o vehículos y/o sujetos activos y/o territorialidad.
		</p>

		<p class="fuente" align="justify">
			<strong> 2.-</strong> En caso de ser afirmativo el punto anterior, proporcione el número de investigación y Fiscal que la esta tramitando;
        </p>

	</div>
	<div id="sangria">
		<p class="fuente" align="justify">
			Solicitando remita el informe de referencia en un término no mayor a 48 horas, ya que estas acciones contribuyen a la búsqueda eficiente del ciudadano <strong> {{--{!! $datos->desaparecidoNombre !!}/{!! $datos->municipio !!} --}} </strong>.   
		</p><br>
		<p class="fuente" align="justify">
