...
<p class="fuente"><strong> LIC. </strong>	<strong> {{--{!! $datos->nombreRemitente !!}--}} </strong>
	...
	<p class="fuente"><strong> Director General de los Servicios Periciales y/o Delegado Regional de Servicios Periciales 	<strong> {{--{!! ???????????? !!}--}}  </strong>, Veracruz (autoridad según sea el caso)</strong>
 </strong>
	</p>
	...
	<div id="sangria">
        ...
        <p class="fuente">
           <strong>1.-</strong> Extracción de la huella dactilar contenida en el documento denominado <strong> {{--{!! $datos->documento !!}--}} </strong>, el cual se anexa con cadena de custodia;
		</p>
       <br>
        <p class="fuente">
           <strong>2.-</strong> Una vez hecho lo anterior sea ingresada al Sistema AFIS para su confronta;
        </p>
         <br>
		<p class="fuente">
           <strong>3.-</strong> Así también se llevó a cabo confronta con las huellas dactilares obtenidas de los cadáveres ingresados al Semefo en calidad de Desconocidos;
		</p>
		<br>
		<p class="fuente">
