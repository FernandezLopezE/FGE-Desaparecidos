		...
		<div class="card border-primary">
			<div class="card-header">
				<div class="row">
					...
					<div class="col">
						<p align="right"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalInformante">NUEVO PERSONA</button></p>
					</div>
				</div>	
			</div>
			<div class="card-body">
				<table class="table table-hover" id="tablePrueba">
				  ...
				  <tbody id='cuerpoT'>
						<tr>
						  <th scope="row">1</th>
						  <td>ALEJANDRO FERNANDEZ PEREZ</td>
						  <td>HERMANO</td>
						  <td>09098789786</td>
						  <td>INFORMANTE</td>
						  <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalInformante">VER/EDITAR</button></td>
						</tr>
				  </tbody>
				</table>
